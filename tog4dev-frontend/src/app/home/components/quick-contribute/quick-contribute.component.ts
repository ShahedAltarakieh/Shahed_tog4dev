...
@Component({
    ...
    templateUrl: './quick-contribute.component.html',
    styleUrl: './quick-contribute.component.scss'
})
export class QuickContributionComponent implements OnInit{
  ...
  ngOnInit() {
    if(this.quickContribution){
      ...
      this.getConvertedPrice(this.quickContribution.price_list[1]);
    }
  }
      ...
      this.pixel.trackViewContentProduct(
        {
          ...
          name: this.quickContribution.title,
          category: "Home",
          price: this.middle_amount = this.quickContribution.price_list[1],
        },
        {
          type: "Home Quick"
        }
