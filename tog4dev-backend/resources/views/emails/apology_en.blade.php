...
<head>
    ...
    <title> معاً للتنمية | اعتذار </title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="width:600px; max-width:100%;">
                    ...
                    <tr>
                        <td align="center" class="content-section">
                            ...
                            <p>We apologize for the error in the previous email due to temporary maintenance and upgrades as part of the Together for Intermediation Services (Together for Development). Please rest assured that this matter is under control, and you will receive another email shortly with the correct proofs.</p>
                            <p>Thank you for your understanding and continued support.</p>
                            <p>Best regards,</p>
                            <p>Together for Intermediation Services (Together for Development)</p>
                        </td>
                    <tr>
                        <td align="center">
