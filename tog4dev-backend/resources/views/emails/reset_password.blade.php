...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>تغير كلمة السر | معاً للوساطة التجارية</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="width:600px; max-width:100%;">
                    ...
                    <tr>
                        <td align="center" class="content-section">
                            <h3>مرحباً {{ $user->first_name }} {{ $user->last_name }},</h3>
                            <p>لقد تلقينا طلباً لإعادة تعيين كلمة المرور الخاصة بحسابك.</p>
                            <a href="{{ $resetLink }}" class="button">إعادة تعيين كلمة المرور</a>
                            <p>رابط إعادة تعيين كلمة المرور سينتهي صلاحيته خلال 60 دقيقة.</p>
                            <p>إذا لم تطلب إعادة تعيين كلمة المرور، فلا حاجة لاتخاذ أي إجراء.</p>
                            <p>مع تحيات،</p>
