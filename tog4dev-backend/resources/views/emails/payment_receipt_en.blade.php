...
<head>
    ...
    <title>Together for Intermediation Services (Together for Development) | Email Delegate</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
...
<!-- 
                    <tr>
                        <td style="direction:ltr;">
                            <p style="font-size: 18px;font-weight: bold;text-align: center;color: #13585d;padding-right:8px;padding-left:10px;">
                                Emergency Relief Projects, Delegate us to buy and deliver fresh bread and clean water to our people in Gaza <a href="https://tog4dev.zbooni.com/products/twryd-m-wkhbz" target="_blank" style="color:#15c;text-decoration:underline">Click Here</a>
                            </p>
                            <p style="font-size: 18px;font-weight: bold;text-align: center;color: #13585d;padding-right:8px;padding-left:10px;">
                                Emergency Relief Projects, Delegate us to buy and deliver fresh bread and clean water to our people in Gaza <a href="https://tog4dev.zbooni.com/products/twryd-m-wkhbz" target="_blank" style="color:#15c;text-decoration:underline">Click Here</a>
                            </p>
                    ...
                    <tr>
                        <td align="center" class="content-section" style="padding-bottom:0px !important">
                            @if($user->email == "invoice.tog4dev2025@gmail.com")
                                <p>
                                    <a id="send-to-whatsapp" href="https://wa.me/{{ $user->phone }}">Redirect to whatsapp</a>
                                </p>
                            @endif
                            <p>Thank You {{ $user->first_name }} {{ $user->last_name }} To delegate our company !</p>
                            <p>
                                We are deeply grateful for your decision to delegate Together for Intermediation Services (Together for Development). Your trust in delegating this mission to us has made a great impact.
                            </p>
                    ...
                    <tr>
                        ...
                        <h2 style="margin-top:0;font-size: 18px;">Details of the Delegated Project for Together for Intermediation Services (Together for Development)</h2>
                    ...
                    <tr>
                        <td align="center" class="content-section">
                            <p>
                            Together, we create the sustainable impact we strive for.
                            For more information about our projects or to get in touch, feel free to reach out to us . Follow us on social media to stay updated on our work
                            </p>
                        </td>
                    </tr>
                    <tr>
