...
<head>
    ...
    <title>Together for Intermediation Services (Together for Development) | Apology</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="width:600px; max-width:100%;">
                    ...
                    <tr>
                        <td align="center" class="content-section">
                            <h3>عزيزي/عزيزتي {{ $user->first_name }} {{ $user->last_name }},</h3>
                            <p>نعتذر عن الخطأ الذي حصل في الإيميل السابق بسبب أعمال صيانة وتطوير مؤقتة ضمن مشروع معاً للتنمية. نؤكد لك أن هذا الأمر تحت التحكم، وسيصلك إيميل آخر قريبًا يحتوي على الإثباتات المطلوبة بشكل صحيح.</p>
                            <p>شكرًا لتفهمك ودعمك المستمر.</p>
                            <p>مع تحيات،</p>
                            <p><strong>فريق معاً للوساطة التجارية</strong></p>
                        </td>
                    <tr>
