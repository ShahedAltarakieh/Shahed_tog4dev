                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="width:600px; max-width:100%;">
                    ...
                    <tr>
                        <td align="center" class="content-section" style="direction:rtl">
                            <h3>الموكّل/ة المحترم/ة {{ $name }},</h3>
                            <p>
                                نودّ إعلامك بأنه بتاريخ
                                <strong>{{ $cancellation_date }}</strong>
                                تم إيقاف اشتراكك الشهري في خدمة
                                <strong>"{{ $title }}"</strong>
                            </p>
                            <p>
                                خلال فترة اشتراكك، كنت سببًا ({{$beneficiaries_msg}}) وانعكس أثر توكيلكم على حياة العائلات يومًا بيوم.
                            </p>
                            <p>ندرك أن الظروف قد تتغيّر، ونُقدّر ثقتك السابقة. بإمكانك إعادة تفعيل الاشتراك في أي وقت يناسبك من خلال موقعنا أو تصفح مشاريعنا الآخرى</p>
                            <p>شكرًا لثقتك، ونتطلع لعودتك متى ما أردت استمرار الخدمة.</p>
                            <p><strong>فريق شركة معًا للتنمية</strong></p>
                        </td>
                    <tr>
