                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="width:600px; max-width:100%;">
                    ...
                    <tr>
                        <td align="center" class="content-section" style="direction:rtl">
                            <h3>الموكل/ة المحترم/ة {{ $name }},</h3>
                            <p>
                                نُحيطكم علمًا بأنه تم إلغاء اشتراككم الشهري في خدمة
                                <strong>"{{ $title }}"</strong>
                                بتاريخ
                                <strong>{{ $cancellation_date }}</strong>
                            </p>
                            <p>نأمل أن نراكم مجددًا ضمن خدماتنا القادمة، ويسعدنا دائمًا استمراركم معنا في تحقيق الأثر الإيجابي.</p>
                            <p>📢 تابعونا للاطلاع على آخر التحديثات والخدمات.</p>
                            <p>مع خالص التحية،</p>
