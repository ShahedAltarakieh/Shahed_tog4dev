...
<head>
    <title> معاً للوساطة التجارية | فريق التحصيل </title>
    <meta charset="UTF-8" />
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="width:600px; max-width:100%;">
                    ...
                    <tr>
                        <td align="center" class="content-section">
                            <h3>
                                عطاؤك يصنع الفرق، وسيتم التواصل معك قريبًا من قِبل فريقنا لتأكيد التفاصيل وترتيب موعد
                                الزيارة.
                                إذا كان لديك أي استفسار، نحن هنا لخدمتك دائمًا تواصل معنا 962779400900
                            </h3>
                        </td>
                    </tr>
                    <tr>
