...
<head>
    ...
    <title>توكيل عبر البريد الإلكتروني | معاً للوساطة التجارية</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="width:600px; max-width:100%;">
                    ...
                    <!-- <tr>
                        <td style="direction:ltr;">
                            ...
                            لمشاهدة فيديو انضمام أ. علاء جابر لمشروع "توكيل الطحين وتوريد المياه" لمعاً للتنمية وتوزيعهم <a href="https://www.instagram.com/reel/DI3iTyAoPNz/?igsh=ejZydW9ydWdiMDk5" target="_blank" style="color:#15c;text-decoration:underline">اضغط هنا</a>
                            </p>
                            <p style="font-size: 18px;font-weight: bold;text-align: center;color: #13585d;padding-right:8px;padding-left:10px;">
                            للمشاركة بمشروع "توكيل الطحين وتوريد المياه النظيفة" لشراء الطحين وتحويله إلى خبز وتوصيله ومشروع تنقية المياه وتوزيعها <a href="https://Tog4Dev.zbni.co/u/QB9Je" target="_blank" style="color:#15c;text-decoration:underline">اضغط هنا</a>
                            </p>
                        </td>
                    </tr> -->
                    ...
                    <tr>
                        <td align="center" class="content-section" style="padding-bottom:0px !important">                            
                            ...
                            <p style="direction:rtl;">
                            نعبر عن امتناننا لاختيارك دعم جهودنا في معًا للوساطة التجارية (معاً للتنمية). توكيلك لنا صنع فرق كبير في حياة الأفراد والمجتمعات.
                            </p>
                    ...
                    <tr>
                        <td align="center" style="padding:20px;direction:rtl;">
                    ...
                    <tr>
                        <td align="center" class="content-section">
                            <p>معًا نصنع الأثر الذي نطمح إليه لمزيد من المعلومات حول مشاريعنا أو للتواصل، لا تتردد في مراسلتنا. تابعنا أيضًا على وسائل التواصل الاجتماعي لتبقى على اطلاع على جهودنا</p>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
