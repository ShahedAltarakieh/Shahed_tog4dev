...
<div class="row">
    <div class="col-12">
        <div class="widget-rounded-circle card-box d-flex justify-content-between">
            <form class='w-100' action="{{ route('testimonials.store', ["type" => $type]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="name" name="name" placeholder='{{ __('app.name') }}' value="{{ old('name') }}" class="form-control">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="name_en">{{ __('app.name') }} (EN)</label>
                                <input type="text" id="name_en" name="name_en" placeholder='{{ __('app.name') }}' value="{{ old('name_en') }}" class="form-control">
                            </div>
                            <div class="form-group col-md-6">
