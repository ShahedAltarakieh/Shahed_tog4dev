...
@include('includes.admin.header', ['label_name' => __('app.testimonials'), "add_button" => route('testimonials.create', ["type" => $type])])
<div class='row mt-3'>
    <div class="col-md-12">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input add_to_home" {{ ($item->show_in_home == 1) ? "checked" : "" }} data-table="testimonials"
                                    ...
                                    <td>
                                        <a class="btn btn-info"
                                            href="{{ route('testimonials.show', ['type' => $type, 'testimonial' => $item->id]) }}">
                                            <i class="mdi mdi-eye-outline"></i>
                                        </a>
                                        <a href="{{ route('testimonials.edit', ["type" => $type, "testimonial" => $item->id]) }}"
                                        ...
                                        <button class='btn btn-danger btn-delete' data-toggle="tooltip" data-placement="top"
                                            ...
                                            data-table="{{$type}}/testimonials" data-id="{{ $item->id }}">
