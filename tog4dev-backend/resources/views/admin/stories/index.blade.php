...
@section('title'){{ __('app.stories') }}@endsection

@section('content')

@include('includes.admin.header', ['label_name' => __('app.stories'), "add_button" => route('stories.create', ["type" => $type])])
<div class='row mt-3'>
    <div class="col-md-12">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input add_to_home" {{ ($item->show_in_home == 1) ? "checked" : "" }} data-table="stories"
                                    ...
                                    <td>
                                        <a class="btn btn-info"
                                            href="{{ route('stories.show', ['type' => $type, 'story' => $item->id]) }}">
                                            <i class="mdi mdi-eye-outline"></i>
                                        </a>
                                        <a href="{{ route('stories.edit', ["type" => $type, "story" => $item->id]) }}"
                                        ...
                                        <button class='btn btn-danger btn-delete' data-toggle="tooltip" data-placement="top"
                                            ...
                                            data-table="{{$type}}/stories" data-id="{{ $item->id }}">
